    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: "var(--bg-void)" }}>
        ...
        <div className="flex items-center justify-between px-6 py-4 gap-6">
          ...
          <div className="flex flex-col gap-2 flex-1">
            <div className="flex items-center justify-between text-sm">
              <span className="font-black tracking-wide" style={{ color: "#e8eef7" }}>{myFighter.name.replace("Inscription #", "#")}</span>
              <span className="font-mono font-bold" style={{ color: myHpColor }}>{myHp}/{myMaxHp}</span>
            </div>
            <div className="hp-bar">
              <motion.div
                className={`hp-bar-fill ${myHpPct < 25 ? "critical" : ""}`}
                style={{ 
                  background: `linear-gradient(90deg, ${myHpColor}, ${myHpColor}cc)`,
                  width: `${myHpPct}%`,
                }}
          ...
          <div className="flex flex-col gap-2 flex-1">
            <div className="flex items-center justify-between text-sm">
              <span className="font-mono font-bold" style={{ color: oppHpColor }}>{oppHp}/{oppMaxHp}</span>
              <span className="font-black tracking-wide" style={{ color: "#e8eef7" }}>{opponent.name.replace("Inscription #", "#")}</span>
            </div>
            <div className="hp-bar">
              <motion.div
                className={`hp-bar-fill ${oppHpPct < 25 ? "critical" : ""}`}
                style={{ 
                  background: `linear-gradient(270deg, ${oppHpColor}, ${oppHpColor}cc)`,
                  width: `${oppHpPct}%`,
                  marginLeft: "auto",
                }}
      ...
      <div className="flex-1 relative flex items-center justify-between px-12 py-10 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(0deg, rgba(247, 147, 26, 0.08) 0%, transparent 100%)",
          }}
        />
        <div
...
function ArenaFighter({
  ...
  const glowColor = fighter.glowColor;
